...
import ModalCambiarProducto from "../../components/plastico/ModalCambiarProducto";
import type { ProductoReemplazo } from "../../components/plastico/ModalCambiarProducto";
import ComboboxInsumo from "../../components/proveedores/ComboboxInsumo";
    ...
    <Dashboard>
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="hidden sm:flex items-center gap-2 px-4 py-2 bg-blue-50 border border-blue-200 rounded-xl">
          ...
          <span className="text-lg font-bold text-blue-700">{formatMoney(totalGeneral, cotOrig?.moneda ?? "MXN")}</span>
        </div>
      </div>
