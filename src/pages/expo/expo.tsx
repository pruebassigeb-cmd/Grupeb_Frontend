...
//     e.preventDefault(); setOver(false); setDragId(null);
...
//         .pcard.dragging{opacity:.3;border-color:#C9922A!important;cursor:grabbing!important;}
//         .pcard{transition:border-color .15s, background .15s;}
//         /* Drawer móvil */
