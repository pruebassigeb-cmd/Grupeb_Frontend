...
// El modal funciona tanto para envíos de paquetería como para reparto local.
// En local la guía es opcional; en paquetería es obligatoria.
interface PropsBase {
  onClose: () => void;
  onCompletado: () => void;
}
...
export default function ModalFotoEnvio(props: Props) {
  ...
  const guiaActual = esPaqueteria
    ? props.envio.numero_guia   || ""
    : props.registro.envio.numero_guia || "";
  const subtitulo = esPaqueteria
    ? `${noPedido} · ${props.envio.paqueteria.nombre}`
    : `${noPedido} · ${props.registro.chofer.nombre}`;
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">
              Pedido <span className="font-semibold text-blue-600">{noPedido}</span>
              {" · "}{cliente}
            </p>
          </div>
          {paso !== "subiendo" && (
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          {paso === "completado" && (
            <div className="flex flex-col items-center gap-4 py-6">
              ...
              <button
                onClick={() => { props.onCompletado(); props.onClose(); }}
              ...
              <div className="space-y-1.5">
                ...
                {guiaActual && (
                  <p className="text-xs text-amber-600 flex items-center gap-1">
                    ...
                    Guía anterior: <span className="font-mono font-semibold">{guiaActual}</span>
                  </p>
                )}
              </div>
                  ...
                  >
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">
                        Galería · Archivos · Cámara &nbsp;·&nbsp; Máx. 10 MB
                      </p>
                    </div>
